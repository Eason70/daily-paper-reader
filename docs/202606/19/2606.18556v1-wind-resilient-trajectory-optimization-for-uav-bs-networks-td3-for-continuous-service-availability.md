...
title_zh: 抗风无人机基站网络轨迹优化：TD3实现连续服务可用性
authors: "Azim Akhtarshenas German Svistunov, Kuangyu Zheng, David Lopez-Perez"
date: 2026-06-17
pdf: "https://arxiv.org/pdf/2606.18556v1"
tags: ["query:safe-rl-cbf"]
score: 6.0
evidence: 基于深度强化学习的无人机基站抗风轨迹控制，保证服务可用性
tldr: 无人机基站易受风扰动导致位置偏移，降低通信链路质量。提出基于TD3的深度强化学习框架，将风扰动建模为随机运动，避免复杂气动建模，学习自适应轨迹策略以维持覆盖。仿真表明该方法优于PPO，显著提升吞吐稳定性与鲁棒性。该工作为风扰环境下无人机通信连续服务提供有效方案。
source: arxiv
...
motivation: 无人机基站受风扰动时位置漂移，导致通信质量恶化，现有方法缺乏自适应能力。
method: 采用TD3算法，将风建模为随机运动扰动，学习策略调整轨迹以优化用户覆盖。
result: 相比PPO等基准，该方法在风扰下吞吐稳定性提升，位置补偿效果显著。
conclusion: TD3框架有效应对风扰，保障无人机基站的连续服务可用性。
---

## 摘要
无人机（UAV）基站极易受到阵风和湍流等风扰动影响，导致位置漂移并降低通信链路质量，尤其是在紧急场景下。为解决这一挑战，我们提出一种基于双延迟深度确定性策略梯度（TD3）算法的深度强化学习框架，用于抗风轨迹调整与定位。该方法将风建模为随机运动扰动，避免了复杂气动建模，从而使TD3智能体能够学习自适应控制策略以维持最优覆盖范围。通过优先考虑湍流条件下以用户为中心的性能指标，所提架构确保在外部干扰下仍能连续提供服务。仿真结果表明，基于TD3的方法有效补偿了风致位移，并在吞吐量稳定性和鲁棒性方面优于包括近端策略优化（PPO）在内的基准方法。
